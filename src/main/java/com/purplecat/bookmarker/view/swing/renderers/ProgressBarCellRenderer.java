...
/**
 * COPIED from the standard class for rendering (displaying) individual cells
 * in a <code>JTable</code> in order to display progress bars.
 * <p>
 *
 ...
 * @see JTable
 */
public class ProgressBarCellRenderer extends JProgressBar
