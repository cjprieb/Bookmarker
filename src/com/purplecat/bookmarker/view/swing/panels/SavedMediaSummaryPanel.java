...
@Singleton
public class SavedMediaSummaryPanel {
	static String TAG = "SavedMediaSummaryPanel";
...
//			_dataAuthorLink._popupMenu.add(new JMenuItem(mQueryAuthorAction));
	...
	public void update(Media view) {
		_logger.log(2, TAG, "summary updated: " + view);
...
//		setLink(_dataSiteLink, view._titleUrl);
	...
	protected void setPlaceAndDateTime(Place lastReadPlace, DateTime lastReadDate, Place updatedPlace, DateTime updatedDate) {
